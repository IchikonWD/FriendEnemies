...
export class TopbarComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        let updateMessageEvent = this.events.updateSendMessageObjectEvent.subscribe((d) => { // @ts-ignore
            this.sendMessageObject.id = d.id; // @ts-ignore
            this.sendMessageObject.name = d.name; // @ts-ignore
        });// @ts-ignore
